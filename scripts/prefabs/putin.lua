...
TUNING.ESCTEMPLATE_HEALTH = 250
TUNING.ESCTEMPLATE_HUNGER = 250
TUNING.ESCTEMPLATE_SANITY = 62 --理智低于55就脱鞋
...
return MakePlayerCharacter("putin", prefabs, assets, common_postinit, master_postinit, prefabs)
